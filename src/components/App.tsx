    ...
    <Stack direction="column" justifyContent="space-between" className="App">
      <div>
        ...
        <Typography sx={{ margin: '0 32px', textAlign: 'center' }}>
          Даний сервіс розроблено для валідації магістерських і бакалаврських робіт у форматі ПДФ.
          <br />
        ...
        <Typography sx={{ margin: '0 32px', textAlign: 'center' }} color="error">
          УВАГА! При наявності рамки ОБОВ'ЯКОВО!!! потрібно заповнити налаштування перевірки рамок.
          <br />
